...
<head>
	<script type = "text/javascript">
		...
		function deleteRow() {
			...
			var retVal = confirm("Do you really want to delete this row ?");
			if( retVal == true ) {
				...
				alert("User doesn't want to delete!");
				return false;
			}
		} 
	</script>
	...
	<body>
		...
		include 'navbar.php'; 
		?>
		<form  method="POST" onsubmit="return submitForm()" action="information_data.php">
			<div class="container"><br><br>
				...
				<div class="row">
					<div class="form-group col">
						...
						<input type="text" name="email"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" required><br>
						...
						<tbody>
							...
							<?php foreach($users as $user) :  ?>
								<tr>
									...
									<td><a class="btn btn-success btn-sm m-3" href="update.php?id=<?= $user['id']; ?>">edit</a><a onclick="return deleteRow();  "  class="btn btn-danger btn-sm m-3" href="delete.php?id=<?= $user['id']; ?>">Delete</a></td>
								</tr>
							<?php endforeach; ?>
						</tbody>
					</table>
